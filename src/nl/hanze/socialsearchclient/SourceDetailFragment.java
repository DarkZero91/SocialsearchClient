...
import nl.hanze.socialsearchclient.dummy.DummyContent;

/**
 * A fragment representing a single Source detail screen. This fragment is
 * either contained in a {@link SourceListActivity} in two-pane mode (on
 * tablets) or a {@link SourceDetailActivity} on handsets.
 */
public class SourceDetailFragment extends Fragment {
	...
	public View onCreateView(LayoutInflater inflater, ViewGroup container,
		...
		View rootView = inflater.inflate(R.layout.fragment_source_detail,
				container, false);
